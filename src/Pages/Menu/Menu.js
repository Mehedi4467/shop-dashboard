        ...
        <div className='mega-menu'>
            <div className='py-4 px-2 shadow-lg rounded-lg'>
                ...
                <div className=',l-4 pb-16 mt-10'>
                    {user && <button onClick={() => signOut(auth)} className=' bg-green-500 py-2 px-6 rounded-full hover:bg-green-600 text-white '><i className="fa-solid fa-arrow-right-from-bracket"></i> Log Out</button>}
