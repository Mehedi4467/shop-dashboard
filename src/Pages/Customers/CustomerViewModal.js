            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <div className='my-6'>
                        ...
                        <p> <span className='text-orange-500'>Joining Date: </span> {customerModal.creationTime}</p>

                        <div>
                            <h2 className='font-bold text-orange-500 text-center'>Address</h2>
                            <div>
                                <p className='capitalize'> <span className='text-orange-500 '>Division: </span> {customerModal?.address?.state}</p>
                                <p className='capitalize'> <span className='text-orange-500 '>City: </span> {customerModal?.address?.city}</p>
                                <p className='capitalize'> <span className='text-orange-500 '>Detail: </span> {customerModal?.address?.detail}</p>
                            </div>
                        </div>
                    </div>
