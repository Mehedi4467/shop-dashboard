...
const ContactUs = () => {
    ...
    return (
        <section className="bg-white py-10  lg:py-16 overflow-hidden container mx-auto px-12 md:px-0 relative z-10">
            <div className="container">
                <div className="flex flex-wrap lg:justify-between -mx-4">
                    <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
                        <div className="max-w-[570px] px-6 mb-12 lg:mb-0">
                      ...
                      "
                            ...
                            <p className="text-base text-body-color leading-relaxed mb-9">
                                Shop in shop Bangladesh or www.shopinshop.com.bd, a registered trade name and is the most trusted online Shopping platform in Bangladesh. Our journey started from September 10, 2021. We take both pre-orders & stock product’s orders from our customers.
                            </p>
                         ...
                         "
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-base text-body-color">
                                        530/A, Baridhara-DOHS, Dhaka-1206,Bangladesh
                                    </p>
                                </div>
                            </div>
                            <div className="flex mb-8 max-w-[370px] w-full">
                         ...
                         "
                                ...
                                <div className="w-full">
                                    ...
                                    <p className="text-base text-body-color">shopinshopbd12@gmail.com</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="w-full lg:w-1/2 xl:w-5/12 px-4">
                        <div className="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                            <form action="mailto:shopinshopbd12@gmail.com" method="post" enctype="text/plain">
                                <div className="mb-6">
                                    <input
                                        type="text"
